...
export const PaymentStatus = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Direct Benefit Transfer (DBT) Status" subtitle="Track direct MSP payments credited to your Aadhaar-seeded bank account" />

      <Card title="Aadhaar Seeded Bank Account Info">
        <div className="text-xs text-slate-700 space-y-1">
          <p><span className="font-semibold">Bank Name:</span> State Bank of India (Ludhiana Branch)</p>
